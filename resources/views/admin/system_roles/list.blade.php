...
<div class="page-header col-xs-12">
	...
	<div class="col-xs-1 pull-right span6">
		<a href="{{ action('Admin\SystemRolesController@create') }}" class="btn btn-app btn-primary no-radius">
						...
						<div class="panel-collapse collapse in" id="collapseOne">
							<div class="panel-body">
								<div class="row">
									...
									<form name="filter_options" id="filter_options" action="{{ action('Admin\SystemRolesController@index') }}">
										<div class="row">
											<div class="col-xs-6 hr4">
				...
				<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
					<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer">
						...
						<tr role="row">
								...
								<th class=" admin_order_field" data-url="#">
						...
						<tbody>
							...
							<tr role="row">
								...
								<td class="hidden-480">
									<span class="label label-sm {{ $value->role_status ? 'label-success' : 'label-warning' }}">{{ $value->role_status ? 'Publish' : 'Unpublish' }}</span>
								</td>
								<td>{{ date('Y-m-d H:i:s',$value->updated_date) }}</td>
								<td>
									<div class="hidden-sm hidden-xs action-buttons">
										<a class="btn btn-xs btn-info" href="{{ action('Admin\SystemRolesController@edit', ['id' => $value->id]) }}" title="Edit">
											<i class="ace-icon fa fa-pencil bigger-120"></i>
										</a>

										{!! Form::open([
											'method' => 'DELETE',
											'action' => ['Admin\SystemRolesController@destroy', $value->id],
