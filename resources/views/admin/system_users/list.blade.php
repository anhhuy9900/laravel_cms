...
<div class="page-header col-xs-12">
	...
	<div class="col-xs-1 pull-right span6">
		<a href="{{ action('Admin\SystemUsersController@create') }}" class="btn btn-app btn-primary no-radius">
							...
							<tr role="row">
								...
								<td>
									<div class="hidden-sm hidden-xs action-buttons">
										<a class="btn btn-xs btn-info" href="{{ action('Admin\SystemUsersController@edit', ['id' => $value->id]) }}" title="Edit">
											<i class="ace-icon fa fa-pencil bigger-120"></i>
										</a>

										{!! Form::open([
											'method' => 'DELETE',
											'action' => ['Admin\SystemUsersController@destroy', $value->id],
