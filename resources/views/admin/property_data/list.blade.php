...
<div class="page-header col-xs-12">
	...
	<div class="col-xs-1 pull-right span6">
		<a href="{{ action('Admin\PropertyDataController@create') }}" class="btn btn-app btn-primary no-radius">
						...
						<div class="panel-collapse collapse in" id="collapseOne">
							<div class="panel-body">
								<div class="row">
									...
									<form name="filter_options" id="filter_options" action="{{ action('Admin\PropertyDataController@index') }}">
										<div class="row">
											<div class="col-xs-6 hr4">
							...
							<tr role="row">
								...
								<td>
									<div class="hidden-sm hidden-xs action-buttons">
										<a class="btn btn-xs btn-info" href="{{ action('Admin\PropertyDataController@edit', ['id' => $value->id]) }}" title="Edit">
											<i class="ace-icon fa fa-pencil bigger-120"></i>
										</a>

										{!! Form::open([
											'method' => 'DELETE',
											'action' => ['Admin\PropertyDataController@destroy', $value->id],
